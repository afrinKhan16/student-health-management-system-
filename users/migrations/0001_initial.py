# Generated by Django 5.2.7 on 2026-04-11 07:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('doctor', 'Doctor'), ('receptionist', 'Receptionist'), ('patient', 'Patient'), ('accountant', 'Accountant')], default='patient', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='bill', to='users.appointment')),
            ],
        ),
        migrations.CreateModel(
            name='Doctor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('appointment', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='prescription', to='users.appointment')),
            ],
        ),
        migrations.CreateModel(
            name='Schedule',
